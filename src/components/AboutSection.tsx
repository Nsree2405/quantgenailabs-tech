    ...
    <Section id="about" className="bg-white">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-4xl font-bold mb-6 text-center">
          About <span className="tech-gradient">TechVerse</span>
        </h2>
        ...
        <div className="mt-16">
          ...
          <p className="text-gray-700 mb-4">
            At TechVerse, we're dedicated to making complex technological concepts accessible to everyone. 
            We believe in the power of knowledge sharing to accelerate innovation and progress.
          </p>
          <p className="text-gray-700">
            Our platform provides in-depth information on emerging technologies, from artificial intelligence 
            to quantum computing, with clear explanations, practical applications, and links to further resources.
          </p>
        </div>
      </div>
    </Section>
