...
const ContactSection = () => {
  return (
    <Section id="contact" className="bg-gradient-to-br from-zinc-900 to-slate-800">
            ...
            <div className="space-y-4">
              <div>
                ...
                <a 
                  ...
                  target="_blank"
                  className="text-gray-300 hover:text-techpurple flex items-center gap-2"
                >
              ...
              <div>
                ...
                <div className="flex space-x-4 mt-2">
                  <a href="https://www.linkedin.com/in/navya-sree-antharam/" className="text-gray-300 hover:text-techpurple">LinkedIn</a>
                  <a href="https://github.com/Nsree2405" className="text-gray-300 hover:text-techpurple">GitHub</a>
                  <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sayitqwerty@gmail.com&su=Subject%20Here&body=Your%20message%20body%20goes%20here" 
                    target="_blank" className="text-gray-300 hover:text-techpurple">Mail</a>
                </div>
              </div>
            </div>
          </div>

          <div className="bg-zinc-800/50 p-8 rounded-lg shadow-md flex flex-col justify-center items-center text-center border border-zinc-700">
