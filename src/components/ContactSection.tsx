...
const ContactSection = () => {
  return (
    <Section id="contact" className="bg-gradient-to-br from-slate-50 to-blue-50 dark:bg-background">
            ...
            <div className="space-y-4">
              <div>
                ...
                <a 
                  ...
                  target="_blank"
                  className="text-gray-600 dark:text-gray-300 hover:text-techpurple dark:hover:text-techpurple flex items-center gap-2">
              ...
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white">Follow Us</h4>
                <div className="flex space-x-4 mt-2">
                  <a href="https://www.linkedin.com/in/navya-sree-antharam/" className="text-gray-600 dark:text-gray-300 hover:text-techpurple dark:hover:text-techpurple">LinkedIn</a>
                  <a href="https://github.com/Nsree2405" className="text-gray-600 dark:text-gray-300 hover:text-techpurple dark:hover:text-techpurple">GitHub</a>
                  ...
                  target="_blank" className="text-gray-600 dark:text-gray-300 hover:text-techpurple dark:hover:text-techpurple">Mail</a>
                </div>
              </div>
            </div>
          </div>

          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md flex flex-col justify-center items-center text-center">
            <h3 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Ready to Collaborate?</h3>
